...
export function About() {
    ...
    return (
        <div id="about" className="w-full">
            <div  className="w-full lg:max-w-[1400px] mx-auto lg:px-0 text-white px-8 md:mt-72 lg:mt-40 mt-[70vh]">
                ...
                <div data-aos="fade-up" className="lg:flex lg:gap-8 ">
                    ...
                    <div className="w-full h-96 p-4 bg-secondary lg:my-0 my-8">
                        ...
                        <p className="mt-8">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>
                    </div>
                </div>
